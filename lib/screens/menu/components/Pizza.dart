...
class pizzaFoods extends StatefulWidget {
  final String docid;
  pizzaFoods({required this.docid});

  @override
  State<pizzaFoods> createState() => _pizzaFoodsState();
}

class _pizzaFoodsState extends State<pizzaFoods> {
  @override
