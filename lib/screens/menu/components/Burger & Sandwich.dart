...
class burgerSandwichFoods extends StatefulWidget {
  final String docid;
  burgerSandwichFoods({required this.docid});

  @override
  State<burgerSandwichFoods> createState() => _burgerSandwichFoodsState();
}

class _burgerSandwichFoodsState extends State<burgerSandwichFoods> {
  @override
